...
public class ATOITest {
	@DataProvider(name = "dp03")
	public Object[][] makeData03() {
    ...
    @Test(dataProvider = "dp03")
    public void testAtoiV2(String input, int expected) throws Exception {
        ATOI atoi = new ATOI();
        int actual = atoi.atoiV2(input);
